...
const method = "getPreferenceCutoffPeriod" as const

export const getPreferenceCutoffPeriodQueryKey = () => getCallClauseQueryKeyWithArgs({ abi, address, method, args: [] })

export const useGetPreferenceCutoffPeriod = () =>
  useCallClause({
    abi,
    address,
    method,
