...
/**
 * Get the quorum at a given block number (with decimals removed)
 ...
 */
export const getProposalQuorum = async (thor: Connex.Thor, blockNumber?: string | number): Promise<string> => {
