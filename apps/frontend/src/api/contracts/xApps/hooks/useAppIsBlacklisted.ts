 ...
 */
export const getAppIsBlacklistedQueryKey = (appId: string) => getCallKey({ method, keyArgs: [appId] })
 ...
 */
export const useAppIsBlacklisted = (appId: string): UseQueryResult<boolean, Error> => {
  return useCall({
    contractInterface,
    contractAddress,
    method,
