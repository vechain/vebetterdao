...
const getVot3ContractAddress = () => {
    const VOT3_CONTRACT = process.env.NEXT_PUBLIC_VOT3_CONTRACT_ADDRESS
    if (!VOT3_CONTRACT) throw new Error("NEXT_PUBLIC_VOT3_CONTRACT_ADDRESS not set")
    return VOT3_CONTRACT
}
...
export const networkConfig = {
    ...
    vot3ContractAddress: getVot3ContractAddress()
}
