    ...
    () => [
      {
        ...
        heading: t("1. What are Quests?"),
        listItems: [
          t(
            "Quests are reward-based challenges powered by B3MO. Compete with friends, sponsor someone you want to motivate, or take on app-sponsored quests - all with B3TR on the line.",
          ),
          t(
            "B3MO holds funds, verifies your actions, determines winners, and pays out automatically - every quest is fair and trustless.",
          ),
        ],
      },
      {
      ...
      },
      {
        ...
        heading: t("3. Sponsored Quests"),
        listItems: [
          t(
            "Fund a quest for someone you want to motivate - a friend, family member, or community member. They stake nothing; you deposit the B3TR reward and B3MO handles the rest.",
          ),
          t(
            "Apps can also sponsor quests to re-engage users. B3MO identifies the right targets and proposes personalised quests.",
          ),
        ],
      },
      {
        ...
        listItems: [
          t(
            "Browse open quests, track your active ones, and review your history. A small protocol fee goes to the VeBetter Treasury, fueling the DAO.",
          ),
          t(
            "Accept quests from B3MO, discover what others are doing, and never miss a quest that needs your attention.",
          ),
        ],
      },
    ],
