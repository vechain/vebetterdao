    ...
    semanticTokens: {
      colors: {
        ...
        brand: {
          ...
          secondary: { value: { base: "{colors.green-brand.400}", _dark: "{colors.green-brand.400}" } },
          "secondary-strong": { value: { base: "{colors.green-brand.600}", _dark: "{colors.gray.700}" } },
        },
        ...
        status: {
          positive: {
            strong: { value: { base: "#047229", _dark: "{colors.green-brand.500}" } },
            primary: { value: { base: "{colors.green.500}", _dark: "{colors.green.500}" } },
            secondary: { value: { base: "{colors.green.200}", _dark: "{colors.green.700}" } },
            subtle: { value: { base: "{colors.green.100}", _dark: "{colors.gray.800}" } },
          },
          negative: {
            strong: { value: { base: "{colors.red.600}", _dark: "{colors.red.400}" } },
            primary: { value: { base: "{colors.red.400}", _dark: "{colors.red.400}" } },
            secondary: { value: { base: "{colors.red.200}", _dark: "{colors.red.700}" } },
            subtle: { value: { base: "{colors.red.100}", _dark: "{colors.gray.800}" } },
          },
          info: {
            strong: { value: { base: "{colors.blue.600}", _dark: "{colors.blue.200}" } },
            primary: { value: { base: "{colors.blue.300}", _dark: "{colors.blue.300}" } },
            secondary: { value: { base: "{colors.blue.200}", _dark: "{colors.blue.700}" } },
            subtle: { value: { base: "{colors.blue.50}", _dark: "{colors.gray.800}" } },
          },
          warning: {
            strong: { value: { base: "{colors.yellow.800}", _dark: "{colors.yellow.400}" } },
            primary: { value: { base: "{colors.yellow.600}", _dark: "{colors.yellow.600}" } },
            secondary: { value: { base: "{colors.yellow.200}", _dark: "{colors.yellow.700}" } },
            subtle: { value: { base: "{colors.yellow.100}", _dark: "{colors.gray.800}" } },
          },
          neutral: {
        ...
        graph: {
          1: { value: { base: "{colors.blue.800}", _dark: "{colors.gray.50}" } },
          2: { value: { base: "{colors.blue.700}", _dark: "{colors.blue.400}" } },
          3: { value: { base: "{colors.blue.500}", _dark: "{colors.blue.500}" } },
          4: { value: { base: "{colors.blue.400}", _dark: "{colors.blue.600}" } },
          5: { value: { base: "{colors.blue.200}", _dark: "{colors.blue.700}" } },
          6: { value: { base: "{colors.blue.50}", _dark: "{colors.blue.800}" } },
        },
        calendar: {
          1: { value: { base: "#739E45", _dark: "{colors.green-brand.400}" } },
          2: { value: { base: "#97CE5B", _dark: "{colors.green-brand.400}" } },
          3: { value: { base: "{colors.green-brand.400}", _dark: "{colors.green-brand.400}" } },
          4: { value: { base: "#B1F16C80", _dark: "{colors.green-brand.400}" } },
        },
