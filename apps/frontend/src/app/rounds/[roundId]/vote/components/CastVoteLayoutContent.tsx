...
const CastAllocationVoteStepperCard = dynamic(
  () => import("./CastAllocationVoteStepperCard").then(mod => mod.CastAllocationVoteStepperCard),
  {
    ssr: false,
    loading: () => (
...
const YourVoteBalanceCard = dynamic(() => import("./YourVoteBalanceCard").then(mod => mod.YourVoteBalanceCard), {
  ssr: false,
  loading: () => (
    <VStack w="full" spacing={12} h="80vh" justify="center">
      <Spinner size={"lg"} />
...
export const CastVoteLayoutContent = ({ children, params }: Readonly<Props>) => {
