...
export const NoActiveProposalCard = () => {
  ...
  return (
    <VStack gap={4} bg="light-contrast-on-card-bg" align="center" w="full" borderRadius="md" py="16px" px="56px">
      <Image src="/assets/icons/no-proposals-icon.svg" boxSize={"78px"} color="#757575" alt="No proposals" />
      <Text textStyle={"md"} fontWeight={500} color={"#757575"} textAlign="center">
