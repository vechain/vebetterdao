...
import { LeaderboardRankingComponent } from "./components/LeaderboardRakingComponent"
import { LeaderboardSearchModal } from "./components/LeaderboardSearchModal"
...
export const Leaderboard = () => {
  ...
  const leaderboardSearchModal = useDisclosure()
  return (
    <>
      <LeaderboardSearchModal isOpen={leaderboardSearchModal.isOpen} onClose={leaderboardSearchModal.onClose} />
        ...
        <CardBody>
          <VStack spacing={6} align="stretch">
            <VStack spacing={2} align="stretch">
              ...
              <Spacer />
              <Input onClick={leaderboardSearchModal.onOpen} placeholder="Search any address or vet domain..." />
            </VStack>
