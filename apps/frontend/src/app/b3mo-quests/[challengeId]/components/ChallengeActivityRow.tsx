...
const getActivityLabel = (type: ActivityEntryType, formattedAmount: string | undefined, t: TFn): string => {
  switch (type) {
    case "created":
      return t("created the B3MO quest")
    case "invited":
    ...
    case "left":
      return t("left the B3MO quest")
    case "cancelled":
      return t("Creator cancelled the B3MO quest")
    case "activated":
      return t("B3MO Quest started")
    case "invalidated":
      return t("B3MO Quest could not start")
    case "completed":
      return t("B3MO Quest ended")
    case "payoutClaimed":
...
const getCompletedLabel = (entry: ChallengeActivityEntry, t: TFn): string | null => {
  ...
  if (entry.settlementMode === SettlementMode.SplitWinCompleted) return t("Split Win B3MO quest completed")
