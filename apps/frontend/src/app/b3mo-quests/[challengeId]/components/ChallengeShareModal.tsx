...
export const ChallengeShareModal = ({ isOpen, onClose, challengeTitle }: Props) => {
  ...
  const shareText = `Check out "${challengeTitle}" on @VeBetterDAO B3MO Quests!\n\n${typeof window !== "undefined" ? window.location.href : ""}\n\n#VeBetterDAO #VeChain`
          ...
          <VStack align="center" p={8} gap={6}>
            <VStack>
              <Heading size="xl" fontWeight="bold" textAlign="center">
                {t("Share this B3MO quest")}
              </Heading>
              <Text textStyle="md" color="text.subtle" textAlign="center">
                {t("Share on social media and help others discover this B3MO quest")}
              </Text>
            </VStack>
