...
import { HStack, TableContainer, Table, TableCaption, Thead, Tr, Th, Tbody, Td, Tfoot } from "@chakra-ui/react"
...
export const AdminPermissions = () => {
  ...
  const isMinterOfB3tr = useHasRole(MINTER_ROLE, config.b3trContractAddress, account ?? undefined)
  const isMinterOfEmissions = useHasRole(MINTER_ROLE, config.emissionsContractAddress, account ?? undefined)
