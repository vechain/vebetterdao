...
import { UnendorsedApp, XApp } from "@/api"
import { useAppEndorsementStatus, useXAppMetadata, useIpfsImage, useXNode } from "@/api"
    ...
    <Card
      ...
      <CardBody py="16px" px="24px">
        <Stack
          ...
          <Stack direction="row" spacing={4} align="center" w="70%">
            ...
            <Stack w="full" maxW="100%" align="flex-start" justify="center">
