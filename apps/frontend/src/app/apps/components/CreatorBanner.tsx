...
import {
  ...
  CreatorApplyNow,
  CreatorApplicationAlreadySubmitted,
} from "./creatorBanners"
import { useHasCreatorNFT, useCreatorSubmission } from "@/api/contracts/x2EarnCreator"
import { useCheckCreatorAlreadyUsed } from "@/api/contracts/xApps"
...
export const CreatorBanner = () => {
  ...
  const { data: hasAlreadySubmitted } = useCheckCreatorAlreadyUsed(account?.address ?? "")
