import { Button, CloseButton, Dialog, Heading, Link, Portal, SimpleGrid, Text, VStack } from "@chakra-ui/react"
  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={details => !details.open && onClose()} size="lg">
      <Portal>
        <Dialog.Backdrop />
        <Dialog.Positioner>
          <Dialog.Content rounded="20px" pt={10} px={3} gap={4}>
            <Dialog.CloseTrigger asChild>
              <CloseButton size="sm" />
            </Dialog.CloseTrigger>
            <Dialog.Header pt={0} textAlign="left">
            ...
            <Dialog.Footer w="full" px={4} pt={4}>
