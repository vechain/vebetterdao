...
import successAnimation from "../SuccessModalContent/success.json"
...
export type SuccessEndorsementContentProps = {
  title?: ReactNode
...
/**
 * SuccessEndorsementContent is a component that shows a success message with a lottie animation and share buttons
 * @param {SuccessEndorsementContentProps} props - The props of the component
 ...
 * @returns {React.ReactElement} The SuccessEndorsementContent component
 */
export const SuccessEndorsementContent = ({
  ...
  txId,
  endorsementInfo,
}: SuccessEndorsementContentProps) => {
