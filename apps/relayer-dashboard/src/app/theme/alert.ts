  ...
  variants: {
    status: {
      info: {
        ...
        indicator: { color: "status.info.strong" },
      },
      warning: {
        root: {
        ...
        indicator: { color: "status.warning.strong" },
      },
      success: {
        root: {
        ...
        indicator: { color: "status.positive.strong" },
      },
      error: {
        root: {
        ...
        indicator: { color: "status.negative.strong" },
      },
      neutral: {
        root: {
        ...
        indicator: { color: "status.neutral.strong" },
      },
    },
  },
})
