...
export const tabsSlotRecipe = defineSlotRecipe({
  ...
  variants: {
    ...
    size: {
      sm: { trigger: { fontSize: "xs", lineHeight: "4" } },
      md: { trigger: { fontSize: "sm", lineHeight: "5" } },
      lg: { trigger: { fontSize: "md", lineHeight: "6" } },
    },
  },
  compoundVariants: [
    { variant: "line", size: "sm", css: { trigger: { px: "2", py: "1" } } },
    { variant: "line", size: "md", css: { trigger: { px: "4", py: "2" } } },
    { variant: "line", size: "lg", css: { trigger: { px: "4", py: "3" } } },
    { variant: "subtle", size: "sm", css: { trigger: { px: "3", py: "1" } } },
    { variant: "subtle", size: "md", css: { trigger: { px: "4", py: "2" } } },
    { variant: "subtle", size: "lg", css: { trigger: { px: "4", py: "3" } } },
  ],
