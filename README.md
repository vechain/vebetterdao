...
Set the `APP_ENV` variable to solo-staging in the `.env` file.
...
Choose what environment to deploy by setting the `APP_ENV` variable to solo-staging in the `.env` file.
