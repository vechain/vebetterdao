...
*/
    ...
    // Navigator Registry
    NAVIGATOR_MIN_STAKE: 50000n * 10n ** 18n,
    NAVIGATOR_MAX_STAKE_PERCENTAGE: 100,
    NAVIGATOR_FEE_LOCK_PERIOD: 4,
    NAVIGATOR_FEE_PERCENTAGE: 2000,
    NAVIGATOR_EXIT_NOTICE_PERIOD: 1,
    NAVIGATOR_REPORT_INTERVAL: 2,
    NAVIGATOR_MINOR_SLASH_PERCENTAGE: 1000,
    NAVIGATOR_PREFERENCE_CUTOFF_PERIOD: 8640,

    XALLOCATION_CITIZEN_SKIP_WINDOW_BLOCKS: 12,
    B3TR_GOVERNOR_SKIP_WINDOW_BLOCKS: 12,
  })
}
