...
export function createTestConfig() {
  return defineConfig({
    ...
    */
    ...
    // VeBetterPassport
    VEPASSPORT_PARTICIPATION_SCORE_THRESHOLD: 0,
    ...
    VEPASSPORT_BLACKLIST_THRESHOLD_PERCENTAGE: 1,
    VEPASSPORT_WHITELIST_THRESHOLD_PERCENTAGE: 1,
    VEPASSPORT_PASSPORT_MAX_ENTITIES: 1,
    VEPASSPORT_DECAY_RATE: 20,
  })
}
