import { Emissions, Treasury, X2EarnApps, X2EarnAppsV1 } from "../../typechain-types"
...
export const setupTestEnvironment = async (emissions: Emissions, x2EarnApps: X2EarnApps | X2EarnAppsV1) => {
...
export const setupMainnetEnvironment = async (emissions: Emissions, x2EarnApps: X2EarnApps | X2EarnAppsV1) => {
