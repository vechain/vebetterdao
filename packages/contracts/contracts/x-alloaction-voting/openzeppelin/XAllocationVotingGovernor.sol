  ...
  IERC1155Receiver
{
  ...
  function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, ERC165) returns (bool) {
    return
      interfaceId == type(IXAllocationVotingGovernor).interfaceId ||
  ...
  /**
   * @dev See {IXAllocationVotingGovernor-hashProposal}.
   *
  ...
  function state(uint256 proposalId) public view virtual returns (AllocationProposalState) {
    ...
    if (proposalExecuted) {
      return AllocationProposalState.Executed;
    }

    if (proposalCanceled) {
      return AllocationProposalState.Canceled;
    }
    ...
    if (deadline >= currentTimepoint) {
      ...
      return AllocationProposalState.Queued;
    }
  }

  /**
   * @dev See {IXAllocationVotingGovernor-proposalThreshold}.
   */
  ...
  /**
   * @dev See {IXAllocationVotingGovernor-proposalEta}.
   */
  ...
  /**
   * @dev See {IXAllocationVotingGovernor-proposalNeedsQueuing}.
   */
  ...
  /**
   * @dev See {IXAllocationVotingGovernor-propose}. This function has opt-in frontrunning protection, described in {_isValidDescriptionForProposer}.
   */
  function propose(
    address[] memory targets,
    uint256[] memory values,
  ...
  /**
   * @dev See {IXAllocationVotingGovernor-queue}.
   */
  function queue(
    address[] memory targets,
    uint256[] memory values,
    ...
    _validateStateBitmap(proposalId, _encodeStateBitmap(AllocationProposalState.Succeeded));
  ...
  /**
   * @dev See {IXAllocationVotingGovernor-execute}.
   */
  function execute(
    address[] memory targets,
    uint256[] memory values,
    ...
    _validateStateBitmap(
      proposalId,
      _encodeStateBitmap(AllocationProposalState.Succeeded) | _encodeStateBitmap(AllocationProposalState.Queued)
    );
  ...
  /**
   * @dev See {IXAllocationVotingGovernor-cancel}.
   */
  function cancel(
    address[] memory targets,
    uint256[] memory values,
    ...
    _validateStateBitmap(proposalId, _encodeStateBitmap(AllocationProposalState.Pending));
   ...
   *
   * Emits a {IXAllocationVotingGovernor-ProposalCanceled} event.
   */
  function _cancel(
    address[] memory targets,
    uint256[] memory values,
    ...
    _validateStateBitmap(
      ...
      ALL_PROPOSAL_STATES_BITMAP ^
        _encodeStateBitmap(AllocationProposalState.Canceled) ^
        _encodeStateBitmap(AllocationProposalState.Expired) ^
        _encodeStateBitmap(AllocationProposalState.Executed)
    );
  ...
  /**
   * @dev See {IXAllocationVotingGovernor-castVoteWithReason}.
   */
  ...
  /**
   * @dev See {IXAllocationVotingGovernor-castVoteWithReasonAndParams}.
   */
  ...
  /**
   * @dev See {IXAllocationVotingGovernor-castVoteBySig}.
   */
  ...
  /**
   * @dev See {IXAllocationVotingGovernor-castVoteWithReasonAndParamsBySig}.
   */
   ...
   * voting weight using {IXAllocationVotingGovernor-getVotes} and call the {_countVote} internal function. Uses the _defaultParams().
   *
