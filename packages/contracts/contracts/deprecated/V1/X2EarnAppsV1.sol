...
import { AdministrationUpgradeableV1 } from "./x-2-earn-apps/modules/AdministrationUpgradeableV1.sol";
import { AppsStorageUpgradeableV1 } from "./x-2-earn-apps/modules/AppsStorageUpgradeableV1.sol";
import { ContractSettingsUpgradeableV1 } from "./x-2-earn-apps/modules/ContractSettingsUpgradeableV1.sol";
import { VoteEligibilityUpgradeableV1 } from "./x-2-earn-apps/modules/VoteEligibilityUpgradeableV1.sol";
...
contract X2EarnAppsV1 is
  ...
  AdministrationUpgradeableV1,
  ContractSettingsUpgradeableV1,
  VoteEligibilityUpgradeableV1,
  AppsStorageUpgradeableV1,
  ...
  UUPSUpgradeable
{
  ...
  function initialize(
    ...
    for (uint256 i; i < _admins.length; i++) {
      require(_admins[i] != address(0), "X2EarnAppsV1: admin address cannot be zero");
  ...
  /**
   * @dev See {IX2EarnAppsV1-setVotingEligibility}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV1-setAppAdmin}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV1-updateTeamWalletAddress}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV1-setTeamAllocationPercentage}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV1-addAppModerator}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV1-removeAppModerator}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV1-addRewardDistributor}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV1-removeRewardDistributor}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV1-updateAppMetadata}.
   */
