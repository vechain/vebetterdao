...
import { IVOT3V1 } from "./interfaces/IVOT3V1.sol";
...
/**
 * @title B3TRGovernorV1AdminUpgradeable
 * @dev This contract is a fork of `B3TRGovernorV1` with the addition of permitting the `DEFUALT_ADMIN_ROLE` to upgrade the contract without having to go through a governance proposal.
 */
contract B3TRGovernorV1AdminUpgradeable is
  IB3TRGovernorV1,
  GovernorStorageV1,
  ...
  PausableUpgradeable
{
  ...
  function initialize(
    ...
    __GovernorStorage_init(data, "B3TRGovernorV1");
    ...
    require(address(rolesData.governorAdmin) != address(0), "B3TRGovernorV1: governor admin address cannot be zero");
  ...
  /**
   * @notice See {IB3TRGovernorV1-proposalProposer}.
   * @param proposalId The id of the proposal
  ...
  /**
   * @notice See {IB3TRGovernorV1-proposalEta}.
   * @param proposalId The id of the proposal
  ...
  /**
   * @notice See {IB3TRGovernorV1-proposalStartRound}
   * @param proposalId The id of the proposal
  ...
  /**
   * @notice See {IB3TRGovernorV1-proposalSnapshot}.
  ...
  /**
   * @notice See {IB3TRGovernorV1-proposalDeadline}.
   * @param proposalId The id of the proposal
  ...
  /**
   * @notice See {IB3TRGovernorV1-getVotes}.
  ...
  /**
   * @notice Returns the quadratic voting power that `account` has.  See {IB3TRGovernorV1-getQuadraticVotingPower}.
   * @param account The address of the account
   ...
   * @return IVOT3V1 The voting token
   */
  function token() external view returns (IVOT3V1) {
    GovernorStorageTypesV1.GovernorStorage storage $ = getGovernorStorage();
    return $.vot3;
  }
  ...
  /**
   * @notice See {B3TRGovernorV1-minVotingDelay}.
  ...
  /**
   * @notice See {IB3TRGovernorV1-votingPeriod}.
  ...
  /**
   * @notice See {IB3TRGovernorV1-hasVoted}.
   * @param proposalId The id of the proposal
   * @param account The address of the account
  ...
  /**
   * @notice See {IB3TRGovernorV1-name}.
  ...
  /**
   * @notice See {IB3TRGovernorV1-version}.
  ...
  /**
   * @notice See {IB3TRGovernorV1-hashProposal}.
   ...
   * @return IVoterRewardsV1 The voter rewards contract
   */
  function voterRewards() external view returns (IVoterRewardsV1) {
    GovernorStorageTypesV1.GovernorStorage storage $ = getGovernorStorage();
    return $.voterRewards;
  }
   ...
   * @return IXAllocationVotingGovernorV1 The XAllocationVotingGovernor contract
   */
  function xAllocationVoting() external view returns (IXAllocationVotingGovernorV1) {
    GovernorStorageTypesV1.GovernorStorage storage $ = getGovernorStorage();
    return $.xAllocationVoting;
  }

  /**
   * @notice See {B3TRGovernorV1-b3tr}.
   * @return IB3TRV1 The B3TR contract
   */
  ...
  /**
   * @notice See {IB3TRGovernorV1-propose}.
  ...
  /**
   * @notice See {IB3TRGovernorV1-queue}.
   * Callable only when contract is not paused.
   * @param targets The list of target addresses
   * @param values The list of values to send
   * @param calldatas The list of call data
  ...
  /**
   * @notice See {IB3TRGovernorV1-execute}.
   * Callable only when contract is not paused.
   * @param targets The list of target addresses
   * @param values The list of values to send
   * @param calldatas The list of call data
  ...
  /**
   * @notice See {IB3TRGovernorV1-castVote}.
   * @param proposalId The id of the proposal
  ...
  /**
   * @notice See {IB3TRGovernorV1-castVoteWithReason}.
   * @param proposalId The id of the proposal
   * @param support The support value (0 = against, 1 = for, 2 = abstain)
   ...
   */
  function setVoterRewards(IVoterRewardsV1 newVoterRewards) public onlyRoleOrGovernance(CONTRACTS_ADDRESS_MANAGER_ROLE) {
    GovernorStorageTypesV1.GovernorStorage storage $ = getGovernorStorage();
  ...
  function setXAllocationVoting(
    IXAllocationVotingGovernorV1 newXAllocationVoting
