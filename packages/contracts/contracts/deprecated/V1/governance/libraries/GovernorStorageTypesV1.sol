...
/// @title GovernorStorageTypesV1
/// @notice Library for defining storage types used in the Governor contract.
library GovernorStorageTypesV1 {
  struct GovernorStorage {
    // ------------------------------- Version 1 -------------------------------

    // ------------------------------- General Storage -------------------------------
    string name; // name of the Governor
    mapping(uint256 proposalId => GovernorTypesV1.ProposalCore) proposals;
    ...
    IXAllocationVotingGovernorV1 xAllocationVoting;
    // B3TR contract
    IB3TRV1 b3tr;
    // VOT3 contract
    IVOT3V1 vot3;
    ...
    mapping(uint256 => GovernorTypesV1.ProposalVote) proposalVotes;
