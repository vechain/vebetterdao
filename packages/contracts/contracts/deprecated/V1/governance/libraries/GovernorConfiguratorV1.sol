...
library GovernorConfiguratorV1 {
   ...
   */
  function setVoterRewards(GovernorStorageTypesV1.GovernorStorage storage self, IVoterRewardsV1 newVoterRewards) external {
  ...
  function updateTimelock(
    ...
    require(address(newTimelock) != address(0), "GovernorConfiguratorV1: timelock address cannot be zero");
