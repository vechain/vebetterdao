...
/**
 * @title VotingSettingsUpgradeableV1
 * @dev Extension of {XAllocationVotingGovernorV1} for voting settings.
 */
abstract contract VotingSettingsUpgradeableV1 is Initializable, XAllocationVotingGovernorV1 {
