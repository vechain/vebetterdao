...
/**
 * @title VotesUpgradeableV1
 * @dev Extension of {XAllocationVotingGovernorV1} for voting weight extraction from an {ERC20Votes} token, or since v4.5 an {ERC721Votes}
 * token.
 */
abstract contract VotesUpgradeableV1 is Initializable, XAllocationVotingGovernorV1 {
