...
/**
 * @title RoundFinalizationUpgradeableV1
 * @notice Extension of {XAllocationVotingGovernorV1} that handles the finalization of rounds
 ...
 */
abstract contract RoundFinalizationUpgradeableV1 is Initializable, XAllocationVotingGovernorV1 {
  ...
  function finalizeRound(uint256 roundId) public virtual override {
    require(!isActive(roundId), "XAllocationVotingGovernorV1: round is not ended yet");
