...
/// @title B3TRV1 Token Contract
/// @dev Extends ERC20 Token Standard with capping, pausing, and access control functionalities to manage B3TRV1 tokens in the VeBetter ecosystem.
/// @notice This contract governs the issuance and management of B3TRV1 fungible tokens within the VeBetter ecosystem, allowing for minting under a capped total supply.
contract B3TRV1 is ERC20Capped, ERC20Pausable, AccessControl {
  bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
  bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");

  /// @notice The maximum amount of B3TRV1 tokens that can be minted
  ...
  constructor(
    ...
    address _pauser
  ) ERC20("B3TRV1", "B3TRV1") ERC20Capped(B3TR_CAP * 1e18) {
    require(_admin != address(0), "B3TRV1: admin address cannot be zero");
