...
library GovernorStorageTypesV9 {
  struct GovernorStorage {
    // ------------------------------- Version 1 -------------------------------

    // ------------------------------- General Storage -------------------------------
    string name; // name of the Governor
    mapping(uint256 proposalId => GovernorTypesV9.ProposalCore) proposals;
    ...
    mapping(uint256 => GovernorTypesV9.ProposalVote) proposalVotes;
    ...
    mapping(uint256 => GovernorTypesV9.ProposalType) proposalType;
    // mapping to store the deposit threshold percentage for each proposal type
    mapping(GovernorTypesV9.ProposalType => uint256) proposalTypeDepositThresholdPercentage;
    // mapping to store the voting threshold for each proposal type
    mapping(GovernorTypesV9.ProposalType => uint256) proposalTypeVotingThreshold;
    // mapping to store the quorum history for each proposal type
    mapping(GovernorTypesV9.ProposalType => Checkpoints.Trace208) proposalTypeQuorum;
    // mapping to store the deposit threshold cap for each proposal type
    mapping(GovernorTypesV9.ProposalType => uint256) proposalTypeDepositThresholdCap;
    ...
    mapping(GovernorTypesV9.ProposalType => uint256) requiredGMLevelByProposalType;
    ...
    mapping(uint256 proposalId => GovernorTypesV9.ProposalDevelopmentState) proposalDevelopmentState;
  }
}
