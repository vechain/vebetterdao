...
library GovernorConfiguratorV9 {
   ...
   */
  function setMinVotingDelay(GovernorStorageTypesV9.GovernorStorage storage self, uint256 newMinVotingDelay) external {
   ...
   */
  function setVoterRewards(GovernorStorageTypesV9.GovernorStorage storage self, IVoterRewards newVoterRewards) external {
  ...
  function setProposalTypeDepositThresholdPercentage(
    ...
    require(GovernorProposalLogicV9.isValidProposalType(proposalType), "GovernorConfigurator: invalid proposal type");
   ...
   */
  function getMinVotingDelay(GovernorStorageTypesV9.GovernorStorage storage self) internal view returns (uint256) {
  ...
  function getRequiredGMLevelByProposalType(
    ...
    require(
      GovernorProposalLogicV9.isValidProposalType(proposalTypeValue),
