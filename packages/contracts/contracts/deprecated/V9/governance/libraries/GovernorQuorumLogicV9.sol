...
library GovernorQuorumLogicV9 {
  ...
  function quorumNumerator(
    ...
    GovernorTypesV9.ProposalType proposalType = GovernorTypesV9.ProposalType.Standard;
  ...
  function quorumNumerator(GovernorStorageTypesV9.GovernorStorage storage self) public view returns (uint256) {
    GovernorTypesV9.ProposalType proposalType = GovernorTypesV9.ProposalType.Standard;
   ...
   */
  function quorum(GovernorStorageTypesV9.GovernorStorage storage self, uint256 timepoint) public view returns (uint256) {
  ...
  function updateQuorumNumerator(
    ...
    _updateQuorumNumeratorByType(self, newQuorumNumerator, GovernorTypesV9.ProposalType.Standard);
  }
  /**
  ...
  function quorumReached(
    ...
    return
      quorumByProposalType(self, GovernorProposalLogicV9._proposalSnapshot(self, proposalId), proposalType) <=
  ...
  function _updateQuorumNumeratorByType(
    ...
    self.proposalTypeQuorum[proposalTypeValue].push(
      GovernorClockLogicV9.clock(self),
