...
import { GovernorStorageTypesV9 } from "./libraries/GovernorStorageTypesV9.sol";
import { GovernorTypesV9 } from "./libraries/GovernorTypesV9.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import { IVeBetterPassport } from "../../../interfaces/IVeBetterPassport.sol";
import { Checkpoints } from "@openzeppelin/contracts/utils/structs/Checkpoints.sol";
import "@openzeppelin/contracts/utils/math/SafeCast.sol";
import { GovernorClockLogicV9 } from "./libraries/GovernorClockLogicV9.sol";
...
contract GovernorStorageV9 is Initializable {
  ...
  function getGovernorStorage() internal pure returns (GovernorStorageTypesV9.GovernorStorage storage $) {
    assembly {
  ...
  function __GovernorStorage_init(
    GovernorTypesV9.InitializationData memory initializationData,
  ...
  function __GovernorStorage_init_unchained(
    ...
    GovernorStorageTypesV9.GovernorStorage storage governorStorage = getGovernorStorage();
  ...
  function __GovernorStorage_init_v7(
    GovernorTypesV9.InitializationDataV7 memory initializationDataV7
  ) internal onlyInitializing {
    GovernorStorageTypesV9.GovernorStorage storage governorStorage = getGovernorStorage();

    // Set deposit threshold for Standard proposal type
    governorStorage.proposalTypeDepositThresholdPercentage[GovernorTypesV9.ProposalType.Standard] = governorStorage
      .depositThresholdPercentage_DEPRECATED;

    // Set deposit threshold for Grant proposal type
    governorStorage.proposalTypeDepositThresholdPercentage[GovernorTypesV9.ProposalType.Grant] = initializationDataV7
      .grantDepositThreshold;

    // Set voting threshold for Standard proposal type
    governorStorage.proposalTypeVotingThreshold[GovernorTypesV9.ProposalType.Standard] = governorStorage
      .votingThreshold_DEPRECATED;

    // Set voting threshold for Grant proposal type
    governorStorage.proposalTypeVotingThreshold[GovernorTypesV9.ProposalType.Grant] = initializationDataV7
    ...
    governorStorage.proposalTypeQuorum[GovernorTypesV9.ProposalType.Grant].push(
      GovernorClockLogicV9.clock(governorStorage),
      SafeCast.toUint208(initializationDataV7.grantQuorum)
    );

    // Set deposit threshold cap for Standard proposal type
    governorStorage.proposalTypeDepositThresholdCap[GovernorTypesV9.ProposalType.Standard] = initializationDataV7
      .standardDepositThresholdCap;

    // Set deposit threshold cap for Grant proposal type
    governorStorage.proposalTypeDepositThresholdCap[GovernorTypesV9.ProposalType.Grant] = initializationDataV7
      .grantDepositThresholdCap;

    // Set GM weight for Standard proposal type
    governorStorage.requiredGMLevelByProposalType[GovernorTypesV9.ProposalType.Standard] = initializationDataV7.standardGMWeight;

    // Set GM weight for Grant proposal type
    governorStorage.requiredGMLevelByProposalType[GovernorTypesV9.ProposalType.Grant] = initializationDataV7.grantGMWeight;
