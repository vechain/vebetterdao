...
import { GovernorProposalLogicV9 } from "./governance/libraries/GovernorProposalLogicV9.sol";
import { GovernorStateLogicV9 } from "./governance/libraries/GovernorStateLogicV9.sol";
import { GovernorVotesLogicV9 } from "./governance/libraries/GovernorVotesLogicV9.sol";
import { GovernorQuorumLogicV9 } from "./governance/libraries/GovernorQuorumLogicV9.sol";
import { GovernorDepositLogicV9 } from "./governance/libraries/GovernorDepositLogicV9.sol";
import { GovernorStorageTypesV9 } from "./governance/libraries/GovernorStorageTypesV9.sol";
import { GovernorClockLogicV9 } from "./governance/libraries/GovernorClockLogicV9.sol";
import { GovernorFunctionRestrictionsLogicV9 } from "./governance/libraries/GovernorFunctionRestrictionsLogicV9.sol";
import { GovernorGovernanceLogicV9 } from "./governance/libraries/GovernorGovernanceLogicV9.sol";
import { GovernorConfiguratorV9 } from "./governance/libraries/GovernorConfiguratorV9.sol";
import { GovernorTypesV9 } from "./governance/libraries/GovernorTypesV9.sol";
import { GovernorStorageV9 } from "./governance/GovernorStorageV9.sol";
import { IVoterRewards } from "../../interfaces/IVoterRewards.sol";
import { IVOT3 } from "../../interfaces/IVOT3.sol";
import { IB3TR } from "../../interfaces/IB3TR.sol";
import { IB3TRGovernorV9 } from "./interfaces/IB3TRGovernorV9.sol";
  ...
  PausableUpgradeable
{
  ...
  modifier onlyGovernance() {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorGovernanceLogicV9.checkGovernance($, _msgSender(), _msgData(), address(this));
    _;
  }
  ...
  receive() external payable virtual {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    if (GovernorGovernanceLogicV9.executor($) != address(this)) {
  ...
  function proposalNeedsQueuing(uint256 proposalId) external view returns (bool) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.proposalNeedsQueuing($, proposalId);
  }

  /**
   * @notice Returns the state of a proposal
   * @param proposalId The id of the proposal
   * @return GovernorTypesV9.ProposalState The state of the proposal
   */
  function state(uint256 proposalId) external view returns (GovernorTypesV9.ProposalState) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorStateLogicV9.state($, proposalId);
  }
  ...
  function canProposalStartInNextRound() public view returns (bool) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.canProposalStartInNextRound($);
  }
  ...
  function proposalProposer(uint256 proposalId) public view virtual returns (address) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.proposalProposer($, proposalId);
  }
  ...
  function proposalEta(uint256 proposalId) public view virtual returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.proposalEta($, proposalId);
  }
  ...
  function proposalStartRound(uint256 proposalId) public view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.proposalStartRound($, proposalId);
  }
  ...
  function proposalSnapshot(uint256 proposalId) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.proposalSnapshot($, proposalId);
  }
  ...
  function proposalDeadline(uint256 proposalId) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.proposalDeadline($, proposalId);
  }
   ...
   */
  function votingThresholdByProposalType(GovernorTypesV9.ProposalType proposalTypeValue) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
  ...
  function getVotes(address account, uint256 timepoint) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorVotesLogicV9.getVotes($, account, timepoint);
  }
  ...
  function getQuadraticVotingPower(address account, uint256 timepoint) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorVotesLogicV9.getQuadraticVotingPower($, account, timepoint);
  }
  ...
  function clock() external view returns (uint48) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorClockLogicV9.clock($);
  }
  ...
  function CLOCK_MODE() external view returns (string memory) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorClockLogicV9.CLOCK_MODE($);
  }
  ...
  function quorum(uint256 blockNumber) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorQuorumLogicV9.quorum($, blockNumber);
  }
  ...
  function quorumNumerator() external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorQuorumLogicV9.quorumNumerator($);
  }
  ...
  function quorumNumerator(uint256 timepoint) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorQuorumLogicV9.quorumNumerator($, timepoint);
  }
  ...
  function quorumDenominator() external pure returns (uint256) {
    return GovernorQuorumLogicV9.quorumDenominator();
  }
  ...
  function isFunctionWhitelisted(address target, bytes4 functionSelector) external view returns (bool) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorFunctionRestrictionsLogicV9.isFunctionWhitelisted($, target, functionSelector);
  }
  ...
  function hasVotedOnce(address user) external view returns (bool) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorVotesLogicV9.userVotedOnce($, user);
  }
  ...
  function quorumReached(uint256 proposalId) external view returns (bool) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorQuorumLogicV9.isQuorumReached($, proposalId);
  }
  ...
  function proposalVotes(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorVotesLogicV9.getProposalVotes($, proposalId);
  }
  ...
  function hasVoted(uint256 proposalId, address account) external view returns (bool) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorVotesLogicV9.hasVoted($, proposalId, account);
  }
  ...
  function getProposalDeposits(uint256 proposalId) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorDepositLogicV9.getProposalDeposits($, proposalId);
  }
  ...
  function proposalDepositReached(uint256 proposalId) external view returns (bool) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorDepositLogicV9.proposalDepositReached($, proposalId);
  }
  ...
  function proposalDepositThreshold(uint256 proposalId) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorDepositLogicV9.proposalDepositThreshold($, proposalId);
  }
  ...
  function getTimelockId(uint256 proposalId) public view returns (bytes32) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.getTimelockId($, proposalId);
  }
  ...
  function getUserDeposit(uint256 proposalId, address user) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorDepositLogicV9.getUserDeposit($, proposalId, user);
  }
  ...
  function isQuadraticVotingDisabledForCurrentRound() external view returns (bool) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorVotesLogicV9.isQuadraticVotingDisabledForCurrentRound($);
  }
  ...
  function isQuadraticVotingDisabledForRound(uint256 roundId) external view returns (bool) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorVotesLogicV9.isQuadraticVotingDisabledForRound($, roundId);
  }
  ...
  function hashProposal(
    ...
    return GovernorProposalLogicV9.hashProposal(targets, values, calldatas, descriptionHash);
  }
  ...
  function timelockSalt(bytes32 descriptionHash) external view returns (bytes32) {
    return GovernorGovernanceLogicV9.timelockSalt(descriptionHash, address(this));
  }
   ...
   * @param proposalId The id of the proposal
   * @return GovernorTypesV9.ProposalType The proposal type
   */
  function proposalType(uint256 proposalId) external view returns (GovernorTypesV9.ProposalType) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.proposalType($, proposalId);
  }

  /** GovernorStorageTypesV9.GovernorStorage storage self = $.governor.getGovernorStorage();
  ...
  function depositThresholdByProposalType(
    GovernorTypesV9.ProposalType proposalTypeValue
  ) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorDepositLogicV9.depositThresholdByProposalType($, proposalTypeValue);
  }
  ...
  function depositThresholdPercentageByProposalType(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorConfiguratorV9.getDepositThresholdPercentage($, proposalTypeValue);
  }
  ...
  function quorumByProposalType(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorQuorumLogicV9.quorumByProposalType($, blockNumber, proposalTypeValue);
  }
   ...
   */
  function quorumNumeratorByProposalType(GovernorTypesV9.ProposalType proposalTypeValue) external view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorQuorumLogicV9.quorumNumeratorByProposalType($, proposalTypeValue);
  }
  /**
   * @notice Returns the quorum numerator at a specific timepoint using the GovernorQuorumFraction library.
   * @param timepoint The timepoint to get the quorum numerator for
  ...
  function quorumNumeratorByProposalType(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorQuorumLogicV9.quorumNumeratorByProposalType($, timepoint, proposalTypeValue);
  }
  ...
  function depositThresholdCapByProposalType(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorConfiguratorV9.getDepositThresholdCap($, proposalTypeValue);
  }
  ...
  function propose(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.propose($, targets, values, calldatas, description, startRoundId, depositAmount);
  }
  ...
  function queue(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.queue($, address(this), targets, values, calldatas, descriptionHash);
  }
  ...
  function execute(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorProposalLogicV9.execute($, address(this), targets, values, calldatas, descriptionHash);
  }
  ...
  function cancel(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return
      GovernorProposalLogicV9.cancel(
        $,
        _msgSender(),
  ...
  function castVote(uint256 proposalId, uint8 support) external returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorVotesLogicV9.castVote($, proposalId, _msgSender(), support, "");
  }
  ...
  function castVoteWithReason(uint256 proposalId, uint8 support, string calldata reason) external returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorVotesLogicV9.castVote($, proposalId, _msgSender(), support, reason);
  }
  ...
  function withdraw(uint256 proposalId, address depositor) external {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorDepositLogicV9.withdraw($, proposalId, depositor);
  }
  ...
  function deposit(uint256 amount, uint256 proposalId) external {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorDepositLogicV9.deposit($, amount, proposalId);
  }
  ...
  function updateQuorumNumerator(uint256 newQuorumNumerator) external onlyRoleOrGovernance(DEFAULT_ADMIN_ROLE) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorQuorumLogicV9.updateQuorumNumerator($, newQuorumNumerator);
  }
  ...
  function toggleQuadraticVoting() external onlyRoleOrGovernance(DEFAULT_ADMIN_ROLE) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorVotesLogicV9.toggleQuadraticVoting($);
  }
  ...
  function setWhitelistFunction(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorFunctionRestrictionsLogicV9.setWhitelistFunction($, target, functionSelector, isWhitelisted);
  }
  ...
  function setWhitelistFunctions(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorFunctionRestrictionsLogicV9.setWhitelistFunctions($, target, functionSelectors, isWhitelisted);
  }
  ...
  function setIsFunctionRestrictionEnabled(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorFunctionRestrictionsLogicV9.setIsFunctionRestrictionEnabled($, isEnabled);
  }
  ...
  function setMinVotingDelay(uint256 newMinVotingDelay) public onlyRoleOrGovernance(DEFAULT_ADMIN_ROLE) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorConfiguratorV9.setMinVotingDelay($, newMinVotingDelay);
  }
  ...
  function setVoterRewards(IVoterRewards newVoterRewards) public onlyRoleOrGovernance(CONTRACTS_ADDRESS_MANAGER_ROLE) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorConfiguratorV9.setVoterRewards($, newVoterRewards);
  }
  ...
  function setXAllocationVoting(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorConfiguratorV9.setXAllocationVoting($, newXAllocationVoting);
  }
  ...
  function updateTimelock(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorConfiguratorV9.updateTimelock($, newTimelock);
  }
  ...
  function setVeBetterPassport(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorConfiguratorV9.setVeBetterPassport($, newVeBetterPassport);
  }
  ...
  function proposeGrant(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return
      GovernorProposalLogicV9.proposeGrant(
        $,
        targets,
        values,
        calldatas,
   ...
   * since pending development is not tracked in {GovernorStateLogicV9._state} condition
   */
  function resetDevelopmentState(uint256 proposalId) public onlyRole(PROPOSAL_STATE_MANAGER_ROLE) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorProposalLogicV9.resetDevelopmentState($, proposalId);
  }
  ...
  function markAsInDevelopment(uint256 proposalId) public onlyRole(PROPOSAL_STATE_MANAGER_ROLE) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorProposalLogicV9.markAsInDevelopment($, proposalId);
  }
  ...
  function markAsCompleted(uint256 proposalId) public onlyRole(PROPOSAL_STATE_MANAGER_ROLE) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorProposalLogicV9.markAsCompleted($, proposalId);
  }
  ...
  function updateQuorumNumeratorByType(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorQuorumLogicV9.updateQuorumNumeratorByType($, newQuorumNumerator, proposalTypeValue);
  }
  ...
  function setProposalTypeDepositThresholdPercentage(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorConfiguratorV9.setProposalTypeDepositThresholdPercentage($, proposalTypeValue, newDepositThreshold);
  }
  ...
  function setProposalTypeVotingThreshold(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorConfiguratorV9.setProposalTypeVotingThreshold($, proposalTypeValue, newVotingThreshold);
  }
  ...
  function setProposalTypeDepositThresholdCap(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorConfiguratorV9.setProposalTypeDepositThresholdCap($, proposalTypeValue, newDepositThresholdCap);
  }
  ...
  function setGalaxyMember(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorConfiguratorV9.setGalaxyMemberContract($, newGalaxyMember);
  }
  ...
  function setGrantsManager(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorConfiguratorV9.setGrantsManagerContract($, newGrantsManager);
  }
  ...
  function setRequiredGMLevelByProposalType(
    ...
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    GovernorConfiguratorV9.setRequiredGMLevelByProposalType($, proposalTypeValue, newGMWeight);
  }
  ...
  function getDepositVotingPower(address account, uint256 timepoint) public view returns (uint256) {
    GovernorStorageTypesV9.GovernorStorage storage $ = getGovernorStorage();
    return GovernorDepositLogicV9.getDepositVotingPower($, account, timepoint);
  }
  ...
  function supportsInterface(
    ...
    return
      interfaceId == type(IB3TRGovernorV9).interfaceId ||
