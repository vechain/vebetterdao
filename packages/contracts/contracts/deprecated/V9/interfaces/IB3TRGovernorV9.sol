 ...
 */
interface IB3TRGovernorV9 is IERC165, IERC6372 {
  /**
   ...
   */
  function depositThresholdByProposalType(GovernorTypesV9.ProposalType proposalTypeValue) external view returns (uint256);
   ...
   */
  function setRequiredGMLevelByProposalType(GovernorTypesV9.ProposalType proposalTypeValue, uint256 newGMWeight) external;
