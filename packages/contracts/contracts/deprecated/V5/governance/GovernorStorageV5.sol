...
import { GovernorStorageTypesV5 } from "./libraries/GovernorStorageTypesV5.sol";
import { GovernorTypesV5 } from "./libraries/GovernorTypesV5.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import { IVeBetterPassport } from "../../../interfaces/IVeBetterPassport.sol";

/// @title GovernorStorageV5
...
contract GovernorStorageV5 is Initializable {
  ...
  function getGovernorStorage() internal pure returns (GovernorStorageTypesV5.GovernorStorage storage $) {
    assembly {
  ...
  function __GovernorStorage_init(
    GovernorTypesV5.InitializationData memory initializationData,
  ...
  function __GovernorStorage_init_unchained(
    ...
    GovernorStorageTypesV5.GovernorStorage storage governorStorage = getGovernorStorage();
