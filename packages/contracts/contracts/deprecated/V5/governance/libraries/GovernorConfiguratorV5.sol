...
/// @title GovernorConfiguratorV5 Library
...
library GovernorConfiguratorV5 {
   ...
   */
  function setMinVotingDelay(GovernorStorageTypesV5.GovernorStorage storage self, uint256 newMinVotingDelay) external {
  ...
  function setVoterRewards(
    ...
    require(address(newVoterRewards) != address(0), "GovernorConfiguratorV5: voterRewards address cannot be zero");
  ...
  function setXAllocationVoting(
    ...
    require(
      ...
      "GovernorConfiguratorV5: xAllocationVoting address cannot be zero"
    );
  ...
  function updateTimelock(
    ...
    require(address(newTimelock) != address(0), "GovernorConfiguratorV5: timelock address cannot be zero");
   ...
   */
  function getVotingThreshold(GovernorStorageTypesV5.GovernorStorage storage self) internal view returns (uint256) {
   ...
   */
  function getMinVotingDelay(GovernorStorageTypesV5.GovernorStorage storage self) internal view returns (uint256) {
