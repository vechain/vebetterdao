...
library GovernorProposalLogicV5 {
  ...
  function queue(
    ...
    GovernorStateLogicV5.validateStateBitmap(
      self,
      proposalId,
      GovernorStateLogicV5.encodeStateBitmap(GovernorTypesV5.ProposalState.Succeeded)
    );
  ...
  function execute(
    ...
    GovernorStateLogicV5.validateStateBitmap(
      ...
      proposalId,
      GovernorStateLogicV5.encodeStateBitmap(GovernorTypesV5.ProposalState.Succeeded) |
        GovernorStateLogicV5.encodeStateBitmap(GovernorTypesV5.ProposalState.Queued)
    );
  ...
  function cancel(
    ...
    GovernorStateLogicV5.validateStateBitmap(
      ...
      GovernorStateLogicV5.ALL_PROPOSAL_STATES_BITMAP ^
        GovernorStateLogicV5.encodeStateBitmap(GovernorTypesV5.ProposalState.Canceled) ^
        GovernorStateLogicV5.encodeStateBitmap(GovernorTypesV5.ProposalState.Executed)
    );

    if (account == proposalProposer(self, proposalId)) {
      require(
        GovernorStateLogicV5._state(self, proposalId) == GovernorTypesV5.ProposalState.Pending,
   ...
   * @return The proposal id.
   */
  function _cancel(GovernorStorageTypesV5.GovernorStorage storage self, uint256 proposalId) private returns (uint256) {
