...
library GovernorDepositLogicV5 {
   ...
   */
  function deposit(GovernorStorageTypesV5.GovernorStorage storage self, uint256 amount, uint256 proposalId) external {
    if (amount == 0) {
    ...
    GovernorStateLogicV5.validateStateBitmap(
      self,
      proposalId,
      GovernorStateLogicV5.encodeStateBitmap(GovernorTypesV5.ProposalState.Pending)
    );
   ...
   */
  function depositThreshold(GovernorStorageTypesV5.GovernorStorage storage self) external view returns (uint256) {
   ...
   * @return uint256 The deposit threshold.
   */
  function _depositThreshold(GovernorStorageTypesV5.GovernorStorage storage self) internal view returns (uint256) {
