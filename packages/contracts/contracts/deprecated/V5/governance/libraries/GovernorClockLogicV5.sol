...
library GovernorClockLogicV5 {
   ...
   */
  function clock(GovernorStorageTypesV5.GovernorStorage storage self) external view returns (uint48) {
  ...
  function CLOCK_MODE(GovernorStorageTypesV5.GovernorStorage storage self) external view returns (string memory) {
