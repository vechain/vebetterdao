...
import { GovernorStorageTypesV5 } from "./governance/libraries/GovernorStorageTypesV5.sol";
...
import { GovernorTypesV5 } from "./governance/libraries/GovernorTypesV5.sol";
import { GovernorStorageV5 } from "./governance/GovernorStorageV5.sol";
  ...
  PausableUpgradeable
{
  ...
  modifier onlyGovernance() {
    GovernorStorageTypesV5.GovernorStorage storage $ = getGovernorStorage();
   ...
   */
  function initialize(
    GovernorTypesV5.InitializationData memory data,
    GovernorTypesV5.InitializationRolesData memory rolesData
  ) external initializer {
    __GovernorStorage_init(data, "B3TRGovernorV5");
    ...
    require(address(rolesData.governorAdmin) != address(0), "B3TRGovernorV5: governor admin address cannot be zero");
   ...
   * @param proposalId The id of the proposal
   * @return GovernorTypesV5.ProposalState The state of the proposal
   */
  function state(uint256 proposalId) external view returns (GovernorTypesV5.ProposalState) {
    GovernorStorageTypesV5.GovernorStorage storage $ = getGovernorStorage();
  ...
  /**
   * @notice See {B3TRGovernorV5-minVotingDelay}.
  ...
  /**
   * @notice See {B3TRGovernorV5-b3tr}.
