...
import { GovernorStorageTypesV2 } from "./libraries/GovernorStorageTypesV2.sol";
import { GovernorTypesV2 } from "./libraries/GovernorTypesV2.sol";
...
contract GovernorStorageV2 is Initializable {
  ...
  function getGovernorStorage() internal pure returns (GovernorStorageTypesV2.GovernorStorage storage $) {
    assembly {
  ...
  function __GovernorStorage_init_unchained(
    ...
    GovernorStorageTypesV2.GovernorStorage storage governorStorage = getGovernorStorage();
