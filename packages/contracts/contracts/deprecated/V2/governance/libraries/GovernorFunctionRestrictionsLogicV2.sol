...
/// @title GovernorFunctionRestrictionsLogicV2
...
library GovernorFunctionRestrictionsLogicV2 {
  ...
  function setWhitelistFunction(
    ...
    require(target != address(0), "GovernorFunctionRestrictionsLogicV2: target is the zero address");
   ...
   */
  function setIsFunctionRestrictionEnabled(GovernorStorageTypesV2.GovernorStorage storage self, bool isEnabled) external {
