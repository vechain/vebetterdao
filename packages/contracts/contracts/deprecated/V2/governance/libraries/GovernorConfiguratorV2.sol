...
/// @title GovernorConfiguratorV2 Library
...
library GovernorConfiguratorV2 {
   ...
   */
  function setVotingThreshold(GovernorStorageTypesV2.GovernorStorage storage self, uint256 newVotingThreshold) external {
   ...
   */
  function setVoterRewards(GovernorStorageTypesV2.GovernorStorage storage self, IVoterRewardsV2 newVoterRewards) external {
    require(address(newVoterRewards) != address(0), "GovernorConfiguratorV2: voterRewards address cannot be zero");
  ...
  function setXAllocationVoting(
    ...
    require(
      ...
      "GovernorConfiguratorV2: xAllocationVoting address cannot be zero"
    );
  ...
  function updateTimelock(
    ...
    require(address(newTimelock) != address(0), "GovernorConfiguratorV2: timelock address cannot be zero");
