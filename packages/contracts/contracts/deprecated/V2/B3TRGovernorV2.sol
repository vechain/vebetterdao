...
import { GovernorProposalLogicV2 } from "./governance/libraries/GovernorProposalLogicV2.sol";
import { GovernorStateLogicV2 } from "./governance/libraries/GovernorStateLogicV2.sol";
import { GovernorVotesLogicV2 } from "./governance/libraries/GovernorVotesLogicV2.sol";
import { GovernorQuorumLogicV2 } from "./governance/libraries/GovernorQuorumLogicV2.sol";
import { GovernorDepositLogicV2 } from "./governance/libraries/GovernorDepositLogicV2.sol";
import { GovernorStorageTypesV2 } from "./governance/libraries/GovernorStorageTypesV2.sol";
import { GovernorClockLogicV2 } from "./governance/libraries/GovernorClockLogicV2.sol";
import { GovernorFunctionRestrictionsLogicV2 } from "./governance/libraries/GovernorFunctionRestrictionsLogicV2.sol";
import { GovernorGovernanceLogicV2 } from "./governance/libraries/GovernorGovernanceLogicV2.sol";
import { GovernorConfiguratorV2 } from "./governance/libraries/GovernorConfiguratorV2.sol";
import { GovernorTypesV2 } from "./governance/libraries/GovernorTypesV2.sol";
...
import { IB3TRGovernorV2 } from "./interfaces/IB3TRGovernorV2.sol";
  ...
  PausableUpgradeable
{
  ...
  modifier onlyGovernance() {
    GovernorStorageTypesV2.GovernorStorage storage $ = getGovernorStorage();
   ...
   */
  function initialize(
    GovernorTypesV2.InitializationData memory data,
    GovernorTypesV2.InitializationRolesData memory rolesData
  ) external initializer {
    __GovernorStorage_init(data, "B3TRGovernorV2");
    __AccessControl_init();
    __UUPSUpgradeable_init();
    __Pausable_init();

    GovernorStorageTypesV2.GovernorStorage storage $ = getGovernorStorage();
    GovernorQuorumLogicV2.updateQuorumNumerator($, data.quorumPercentage);

    // Validate and set the governor external contracts storage
    require(address(rolesData.governorAdmin) != address(0), "B3TRGovernorV2: governor admin address cannot be zero");
  ...
  /**
   * @notice See {IB3TRGovernorV2-proposalProposer}.
   * @param proposalId The id of the proposal
  ...
  /**
   * @notice See {IB3TRGovernorV2-proposalEta}.
   * @param proposalId The id of the proposal
  ...
  /**
   * @notice See {IB3TRGovernorV2-proposalStartRound}
   * @param proposalId The id of the proposal
  ...
  /**
   * @notice See {IB3TRGovernorV2-proposalSnapshot}.
  ...
  /**
   * @notice See {IB3TRGovernorV2-proposalDeadline}.
   * @param proposalId The id of the proposal
  ...
  /**
   * @notice See {IB3TRGovernorV2-getVotes}.
  ...
  /**
   * @notice Returns the quadratic voting power that `account` has.  See {IB3TRGovernorV2-getQuadraticVotingPower}.
   * @param account The address of the account
   ...
   * @return IVOT3V2 The voting token
   */
  function token() external view returns (IVOT3V2) {
    GovernorStorageTypesV2.GovernorStorage storage $ = getGovernorStorage();
    return $.vot3;
  }
  ...
  /**
   * @notice See {B3TRGovernorV2-minVotingDelay}.
  ...
  /**
   * @notice See {IB3TRGovernorV2-votingPeriod}.
  ...
  /**
   * @notice See {IB3TRGovernorV2-hasVoted}.
   * @param proposalId The id of the proposal
   * @param account The address of the account
  ...
  /**
   * @notice See {IB3TRGovernorV2-name}.
  ...
  /**
   * @notice See {IB3TRGovernorV2-version}.
  ...
  /**
   * @notice See {IB3TRGovernorV2-hashProposal}.
  ...
  /**
   * @notice See {B3TRGovernorV2-b3tr}.
   * @return IB3TRV2 The B3TR contract
   */
  ...
  /**
   * @notice See {IB3TRGovernorV2-propose}.
  ...
  /**
   * @notice See {IB3TRGovernorV2-queue}.
   * Callable only when contract is not paused.
   * @param targets The list of target addresses
   * @param values The list of values to send
   * @param calldatas The list of call data
  ...
  /**
   * @notice See {IB3TRGovernorV2-execute}.
   * Callable only when contract is not paused.
   * @param targets The list of target addresses
   * @param values The list of values to send
   * @param calldatas The list of call data
  ...
  /**
   * @notice See {IB3TRGovernorV2-castVote}.
   * @param proposalId The id of the proposal
  ...
  /**
   * @notice See {IB3TRGovernorV2-castVoteWithReason}.
   * @param proposalId The id of the proposal
   * @param support The support value (0 = against, 1 = for, 2 = abstain)
