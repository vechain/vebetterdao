...
/// @title GalaxyMemberV2 NFT Contract
  ...
  UUPSUpgradeable
{
  ...
  /// @notice Storage structure for GalaxyMemberV2
  ...
  /// @notice Initializes a new GalaxyMemberV2 contract
  ...
  function upgrade(uint256 tokenId) external nonReentrant whenNotPaused {
    ...
    require($.b3tr.transferFrom(msg.sender, $.treasury, b3trRequired), "GalaxyMemberV2: Transfer failed");
