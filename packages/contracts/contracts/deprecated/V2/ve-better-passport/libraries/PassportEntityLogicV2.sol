...
library PassportEntityLogicV2 {
   ...
   */
  function setMaxEntitiesPerPassport(PassportStorageTypesV2.PassportStorage storage self, uint256 maxEntities) external {
  ...
  function _checkLink(
    ...
    if (PassportDelegationLogicV2.isDelegatee(self, entity) || self.pendingDelegationsDelegateeToDelegators[entity].length != 0) {
      revert DelegatedEntity(entity);
    }
