...
library PassportWhitelistAndBlacklistLogicV2 {
  ...
  function isWhitelisted(PassportStorageTypesV2.PassportStorage storage self, address user) internal view returns (bool) {
    return self.whitelisted[user];
  }

  /// @notice Returns if a user is blacklisted
  function isBlacklisted(PassportStorageTypesV2.PassportStorage storage self, address user) internal view returns (bool) {
