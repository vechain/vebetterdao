...
/**
 * @title VotesUpgradeableV2
 * @dev Extension of {XAllocationVotingGovernorV2} for voting weight extraction from an {ERC20Votes} token, or since v4.5 an {ERC721Votes}
 * token.
 */
abstract contract VotesUpgradeableV2 is Initializable, XAllocationVotingGovernorV2 {
