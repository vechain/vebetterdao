...
/**
 * @title RoundFinalizationUpgradeableV2
 * @notice Extension of {XAllocationVotingGovernorV2} that handles the finalization of rounds
 ...
 */
abstract contract RoundFinalizationUpgradeableV2 is Initializable, XAllocationVotingGovernorV2 {
  ...
  function finalizeRound(uint256 roundId) public virtual override {
    require(!isActive(roundId), "XAllocationVotingGovernorV2: round is not ended yet");
