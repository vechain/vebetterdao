...
/**
 * @title RoundVotesCountingUpgradeableV2
 *
 * @dev Extension of {XAllocationVotingGovernorV2} for counting votes for allocation rounds.
 *
 * In every round users can vote a fraction of their balance for the eligible apps in that round.
 */
abstract contract RoundVotesCountingUpgradeableV2 is Initializable, XAllocationVotingGovernorV2 {
  struct RoundVote {
