...
import { XAllocationVotingGovernorV2 } from "../XAllocationVotingGovernorV2.sol";
...
/**
 * @title ExternalContractsUpgradeableV2
 * @dev Extension of {XAllocationVotingGovernorV2} that handles the storage of external contracts for the XAllocationVotingGovernorV2.
 */
abstract contract ExternalContractsUpgradeableV2 is Initializable, XAllocationVotingGovernorV2 {
  ...
  function _setEmissions(IEmissionsV2 newEmisionsAddress) internal virtual {
    require(address(newEmisionsAddress) != address(0), "XAllocationVotingGovernorV2: emissions is the zero address");
    ExternalContractsStorage storage $ = _getExternalContractsStorage();
  ...
  function _setX2EarnApps(IX2EarnAppsV2 newX2EarnApps) internal virtual {
    require(address(newX2EarnApps) != address(0), "XAllocationVotingGovernorV2: new X2EarnApps is the zero address");
  ...
  function _setVoterRewards(IVoterRewardsV2 newVoterRewards) internal virtual {
    require(address(newVoterRewards) != address(0), "XAllocationVotingGovernorV2: new voter rewards is the zero address");
