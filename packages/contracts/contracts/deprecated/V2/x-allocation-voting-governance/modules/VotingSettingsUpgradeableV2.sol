...
/**
 * @title VotingSettingsUpgradeableV2
 * @dev Extension of {XAllocationVotingGovernorV2} for voting settings.
 */
abstract contract VotingSettingsUpgradeableV2 is Initializable, XAllocationVotingGovernorV2 {
