...
import { IXAllocationPoolV3 } from "./interfaces/IXAllocationPoolV3.sol";
...
import { ITreasuryV3 } from "./interfaces/ITreasuryV3.sol";
...
import { IX2EarnRewardsPoolV3 } from "./interfaces/IX2EarnRewardsPoolV3.sol";

/**
 * @title XAllocationPoolV3
 ...
 */
contract XAllocationPoolV3 is IXAllocationPoolV3, AccessControlUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
  ...
  struct XAllocationPoolStorage {
    IXAllocationVotingGovernorV3 _xAllocationVoting;
    IEmissionsV3 _emissions;
    IB3TRV3 b3tr;
    ITreasuryV3 treasury;
    IX2EarnAppsV3 x2EarnApps;
    IX2EarnRewardsPoolV3 x2EarnRewardsPool;
  ...
  function initialize(
    ...
    require(_b3trAddress != address(0), "XAllocationPoolV3: new b3tr is the zero address");
    require(_treasury != address(0), "XAllocationPoolV3: new treasury is the zero address");
    require(_x2EarnApps != address(0), "XAllocationPoolV3: new x2EarnApps is the zero address");
    require(_x2EarnRewardsPool != address(0), "XAllocationPoolV3: new x2EarnRewardsPool is the zero address");
    ...
    $.b3tr = IB3TRV3(_b3trAddress);
    $.treasury = ITreasuryV3(_treasury);
    $.x2EarnApps = IX2EarnAppsV3(_x2EarnApps);
    $.x2EarnRewardsPool = IX2EarnRewardsPoolV3(_x2EarnRewardsPool);

    require(_admin != address(0), "XAllocationPoolV3: new admin is the zero address");
  ...
  function setXAllocationVotingAddress(address xAllocationVoting_) external onlyRole(CONTRACTS_ADDRESS_MANAGER_ROLE) {
    require(xAllocationVoting_ != address(0), "XAllocationPoolV3: new xAllocationVoting is the zero address");

    XAllocationPoolStorage storage $ = _getXAllocationPoolStorage();
    $._xAllocationVoting = IXAllocationVotingGovernorV3(xAllocationVoting_);
  ...
  function setEmissionsAddress(address emissions_) external onlyRole(CONTRACTS_ADDRESS_MANAGER_ROLE) {
    require(emissions_ != address(0), "XAllocationPoolV3: new emissions is the zero address");

    XAllocationPoolStorage storage $ = _getXAllocationPoolStorage();
    $._emissions = IEmissionsV3(emissions_);
  ...
  function setTreasuryAddress(address treasury_) external onlyRole(CONTRACTS_ADDRESS_MANAGER_ROLE) {
    require(treasury_ != address(0), "XAllocationPoolV3: new treasury is the zero address");

    XAllocationPoolStorage storage $ = _getXAllocationPoolStorage();
    $.treasury = ITreasuryV3(treasury_);
  ...
  function setX2EarnAppsAddress(address x2EarnApps_) external onlyRole(CONTRACTS_ADDRESS_MANAGER_ROLE) {
    require(x2EarnApps_ != address(0), "XAllocationPoolV3: new x2EarnApps is the zero address");

    XAllocationPoolStorage storage $ = _getXAllocationPoolStorage();
    $.x2EarnApps = IX2EarnAppsV3(x2EarnApps_);
  ...
  function claim(uint256 roundId, bytes32 appId) external nonReentrant {
    ...
    require(!$.claimedRewards[appId][roundId], "XAllocationPoolV3: rewards already claimed for this app and round");
    require(!xAllocationVoting().isActive(roundId), "XAllocationPoolV3: round not ended yet");
    require($.x2EarnApps.appExists(appId), "XAllocationPoolV3: app does not exist");
    ...
    require(amountToClaim > 0, "XAllocationPoolV3: no rewards available for this app");
    ...
    require(
      ...
      "XAllocationPoolV3: Insufficient funds on contract"
    );
    ...
    require(
      ...
      "XAllocationPoolV3: transfer to team wallet failed"
    );
    ...
    require(
      ...
      "XAllocationPoolV3: Approval of B3TR token to x2EarnRewardsPool failed"
    );
    require(
      $.x2EarnRewardsPool.deposit(x2EarnRewardsPoolAmount, appId),
      "XAllocationPoolV3: Deposit of rewards allocation to x2EarnRewardsPool failed"
    );
    ...
    if (unallocatedAmount > 0) {
      require(
        ...
        "XAllocationPoolV3: Transfer of unallocated rewards to treasury failed"
      );
    }
  ...
  function _emissionAmount(uint256 roundId) internal view returns (uint256) {
    IEmissionsV3 _emissions = emissions();
    require(_emissions != IEmissionsV3(address(0)), "Emissions contract not set");
  ...
  {
    IXAllocationVotingGovernorV3 _xAllocationVoting = xAllocationVoting();

    require(_xAllocationVoting != IXAllocationVotingGovernorV3(address(0)), "XAllocationVotingGovernor contract not set");
    ...
    IXAllocationVotingGovernorV3.RoundState state = _xAllocationVoting.state(roundId);
    if (
      state == IXAllocationVotingGovernorV3.RoundState.Active || state == IXAllocationVotingGovernorV3.RoundState.Succeeded
    ) {
   ...
   */
  function xAllocationVoting() public view returns (IXAllocationVotingGovernorV3) {
    XAllocationPoolStorage storage $ = _getXAllocationPoolStorage();
   ...
   */
  function emissions() public view returns (IEmissionsV3) {
    XAllocationPoolStorage storage $ = _getXAllocationPoolStorage();
    return $._emissions;
  }
   ...
   * @dev Returns the emissions contract.
   */
  function treasury() external view returns (ITreasuryV3) {
    XAllocationPoolStorage storage $ = _getXAllocationPoolStorage();
    return $.treasury;
  }
   ...
   */
  function b3tr() external view returns (IB3TRV3) {
    XAllocationPoolStorage storage $ = _getXAllocationPoolStorage();
    return $.b3tr;
  }
   ...
   */
  function x2EarnApps() external view returns (IX2EarnAppsV3) {
    XAllocationPoolStorage storage $ = _getXAllocationPoolStorage();
    return $.x2EarnApps;
  }
