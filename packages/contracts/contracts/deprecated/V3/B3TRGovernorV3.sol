  ...
  PausableUpgradeable
{
  ...
  function initialize(
    ...
    __GovernorStorage_init(data, "B3TRGovernorV3");
    ...
    require(address(rolesData.governorAdmin) != address(0), "B3TRGovernorV3: governor admin address cannot be zero");
   ...
   * @return IVOT3V3 The voting token
   */
  function token() external view returns (IVOT3V3) {
    GovernorStorageTypesV3.GovernorStorage storage $ = getGovernorStorage();
    return $.vot3;
  }
  ...
  /**
   * @notice See {B3TRGovernorV3-minVotingDelay}.
   ...
   * @return IVoterRewardsV3 The voter rewards contract
   */
  function voterRewards() external view returns (IVoterRewardsV3) {
    GovernorStorageTypesV3.GovernorStorage storage $ = getGovernorStorage();
    return $.voterRewards;
  }
   ...
   * @return IXAllocationVotingGovernorV3 The XAllocationVotingGovernor contract
   */
  function xAllocationVoting() external view returns (IXAllocationVotingGovernorV3) {
    GovernorStorageTypesV3.GovernorStorage storage $ = getGovernorStorage();
    return $.xAllocationVoting;
  }

  /**
   * @notice See {B3TRGovernorV3-b3tr}.
   * @return IB3TRV3 The B3TR contract
   */
   ...
   */
  function setVoterRewards(IVoterRewardsV3 newVoterRewards) public onlyRoleOrGovernance(CONTRACTS_ADDRESS_MANAGER_ROLE) {
    GovernorStorageTypesV3.GovernorStorage storage $ = getGovernorStorage();
  ...
  function setXAllocationVoting(
    IXAllocationVotingGovernorV3 newXAllocationVoting
