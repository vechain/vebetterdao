  ...
  UUPSUpgradeable
{
  ...
  function initialize(
    ...
    for (uint256 i; i < _admins.length; i++) {
      require(_admins[i] != address(0), "X2EarnAppsV3: admin address cannot be zero");
  ...
  /**
   * @dev See {IX2EarnAppsV3-setVotingEligibility}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV3-setAppAdmin}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV3-updateTeamWalletAddress}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV3-setTeamAllocationPercentage}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV3-addAppModerator}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV3-removeAppModerator}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV3-addRewardDistributor}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV3-removeRewardDistributor}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV3-updateAppMetadata}.
   */
