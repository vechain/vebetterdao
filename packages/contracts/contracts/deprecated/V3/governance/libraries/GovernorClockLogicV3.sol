...
/// @title GovernorClockLogicV3 Library
/// @notice Library for managing the clock logic as specified in EIP-6372, with fallback to block numbers.
/// @dev This library interacts with the IVOT3V3 interface to get the clock time or mode.
library GovernorClockLogicV3 {
  /**
   ...
   */
  function clock(GovernorStorageTypesV3.GovernorStorage storage self) external view returns (uint48) {
