...
library GovernorVotesLogicV3 {
  ...
  function castVote(
    ...
    GovernorStateLogicV3.validateStateBitmap(self, proposalId, GovernorStateLogicV3.encodeStateBitmap(GovernorTypesV3.ProposalState.Active));

    uint256 weight = self.vot3.getPastVotes(voter, GovernorProposalLogicV3._proposalSnapshot(self, proposalId));
    ...
    self.voterRewards.registerVote(GovernorProposalLogicV3._proposalSnapshot(self, proposalId), voter, weight, Math.sqrt(weight));
