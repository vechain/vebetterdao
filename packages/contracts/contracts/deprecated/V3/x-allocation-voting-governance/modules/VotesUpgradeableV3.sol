...
/**
 * @title VotesUpgradeableV3
 * @dev Extension of {XAllocationVotingGovernorV3} for voting weight extraction from an {ERC20Votes} token, or since v4.5 an {ERC721Votes}
 * token.
 */
abstract contract VotesUpgradeableV3 is Initializable, XAllocationVotingGovernorV3 {
