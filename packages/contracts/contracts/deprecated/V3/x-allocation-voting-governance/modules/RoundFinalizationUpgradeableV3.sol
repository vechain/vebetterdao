...
/**
 * @title RoundFinalizationUpgradeableV3
 * @notice Extension of {XAllocationVotingGovernorV3} that handles the finalization of rounds
 ...
 */
abstract contract RoundFinalizationUpgradeableV3 is Initializable, XAllocationVotingGovernorV3 {
  ...
  function finalizeRound(uint256 roundId) public virtual override {
    require(!isActive(roundId), "XAllocationVotingGovernorV3: round is not ended yet");
