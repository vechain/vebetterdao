...
/**
 * @title VotingSettingsUpgradeableV3
 * @dev Extension of {XAllocationVotingGovernorV3} for voting settings.
 */
abstract contract VotingSettingsUpgradeableV3 is Initializable, XAllocationVotingGovernorV3 {
