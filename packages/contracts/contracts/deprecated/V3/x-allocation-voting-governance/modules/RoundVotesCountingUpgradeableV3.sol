...
/**
 * @title RoundVotesCountingUpgradeableV3
 *
 * @dev Extension of {XAllocationVotingGovernorV3} for counting votes for allocation rounds.
 *
 * In every round users can vote a fraction of their balance for the eligible apps in that round.
 */
abstract contract RoundVotesCountingUpgradeableV3 is Initializable, XAllocationVotingGovernorV3 {
  struct RoundVote {
