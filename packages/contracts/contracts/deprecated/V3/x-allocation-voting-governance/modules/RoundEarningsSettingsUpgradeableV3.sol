...
/**
 * @title RoundEarningsSettingsUpgradeableV3
 * @notice Extension of {XAllocationVotingGovernorV3} to handle the settings for the x-allocation earnings calculations:
 ...
 */
abstract contract RoundEarningsSettingsUpgradeableV3 is Initializable, XAllocationVotingGovernorV3 {
  ...
  function _setBaseAllocationPercentage(uint256 baseAllocationPercentage_) internal {
    require(
      ...
      "XAllocationVotingGovernorV3: Base allocation percentage must be less than or equal to 100"
    );
    EarningsSettingsStorage storage $ = _getEarningsSettingsStorage();
  ...
  function _setAppSharesCap(uint256 appSharesCap_) internal {
    require(appSharesCap_ <= 100, "XAllocationVotingGovernorV3: App shares cap must be less than or equal to 100");
    EarningsSettingsStorage storage $ = _getEarningsSettingsStorage();
