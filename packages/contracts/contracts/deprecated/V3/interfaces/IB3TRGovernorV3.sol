...
import { IB3TRV3 } from "./IB3TRV3.sol";
 ...
 */
interface IB3TRGovernorV3 is IERC165, IERC6372 {
  /**
   ...
   */
  error GovernorUnexpectedProposalState(uint256 proposalId, GovernorTypesV3.ProposalState current, bytes32 expectedStates);
