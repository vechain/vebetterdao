 ...
 * ----- Version 6 -----
 * - Updated the X2EarnApps interface to allow locking funds mechanism
 */
  ...
  ReentrancyGuardUpgradeable
{
  ...
  struct X2EarnRewardsPoolStorage {
    ...
    mapping(bytes32 => uint256) availableFunds; // Funds that the app can use to reward users
    mapping(bytes32 => uint256) lockedFunds; // Amount of funds locked by the app owner
