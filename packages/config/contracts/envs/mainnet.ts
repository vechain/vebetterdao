...
export function createMainnetConfig() {
  return defineConfig({
    ...
    // @ts-ignore
    MIGRATION_AMOUNT: "3750000",
    B3TR_CAP: 1_000_000_000,
    ...
    */
    ...
    EMISSIONS_X_ALLOCATION_DECAY_PERIOD: 999999, // should never decay in pilot show //TODO
    EMISSIONS_VOTE_2_EARN_ALLOCATION_DECAY_PERIOD: 999999, // should never decay in pilot show //TODO
    EMISSIONS_TREASURY_PERCENTAGE: 8750, // 87.5% of the emissions go to the treasury during pilot show
    EMISSIONS_MAX_VOTE_2_EARN_DECAY_PERCENTAGE: 80, //TODO
    ...
    CONTRACTS_ADMIN_ADDRESS: "0xE3D511ce183D3C53813BEA223Fe1E51BB9fF14a4", //TODO
    ...
    GM_NFT_BASE_URI: "ipfs://bafybeiahr3qobzujfkxi64o6wrigkmdagrvgfa566rqqth6jm5nq7vf24y/", // IPFS base URI for the GM NFT //TODO: do we need to update?
    /*
      Level => B3TR Required
      2 (Moon) => 10,000 B3TR
