export type ContractsConfig = {
  ...
  // VeBetterPassport
  VEPASSPORT_PARTICIPATION_SCORE_THRESHOLD: number
  ...
  VEPASSPORT_ROUNDS_FOR_ASSIGNING_ENTITY_SCORE: number
  VEPASSPORT_BLACKLIST_THRESHOLD: number
  VEBETTER_WHITELIST_THRESHOLD: number
  VEBETTER_PASSPORT_MAX_ENTITIES: number
}
