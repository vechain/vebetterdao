...
const VET_DOMAINS_CONTRACT_ADDRESS_MOCK = "0xE27C72E252D5C3B2daf871aB7628F29370438589"
...
const resetSignalCounter = async (thor: ThorClient, bannedWallet: string, reason: string) => {
  ...
  const clause = clauseBuilder.functionInteraction(
    stagingConfig.veBetterPassportContractAddress,
...
export const handler = async (event: any, context: Context): Promise<APIGatewayProxyResult> => {
  ...
  console.log(`Interacting with contract: ${stagingConfig.veBetterPassportContractAddress} on network: ${NODE_URL}`)
