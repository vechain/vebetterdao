const X_ALLOCATIONS_ABI_TESTNET = [
  {
    inputs: [
      {
...
const X_ALLOCATIONS_POOL_ABI = [
  ...
  {
    inputs: [],
    name: "percentagePrecisionScalingFactor",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  {
    inputs: [],
    name: "variableAllocationPercentage",
    outputs: [
      {
        internalType: "uint256",
        name: "",
...
export const xallocationsVotingABI = JSON.stringify(X_ALLOCATIONS_ABI_TESTNET)

export const xallocationsPoolABI = JSON.stringify(X_ALLOCATIONS_POOL_ABI)
